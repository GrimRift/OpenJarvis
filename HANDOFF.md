...
- **Class reminders now actually fire, and speak (2026-09-02).**
  ...
  - **Spoken aloud in Sage's own voice**, as an addition to the toast, never a replacement. Neither ffplay nor ffmpeg is installed here and `os.startfile` pops a visible media window, so playback goes through Windows Media Player's COM object, launched without waiting. Text is short by request: *"Methods of Research in 15 minutes."*
