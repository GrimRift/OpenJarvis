...
- **YouTube playback stopped stuttering while Sage is running (2026-09-02).**
  ...
  - 1116 pass across the engine and memory suites; the 18 failures are the documented pre-existing set, identical with the change stashed. Ruff clean in `src/` and `tests/`.
